      ...
      services: [
        {
          ...
          info: `The houses indicated are located within secure locations.
                    ...
                    So you dont worry about coming out late or going for that vacay.`
        },
        {
          icon: <IoIosBicycle />,
          title: "transportation",
          info: `Want to come home late and not have trouble finding your way back? 
                    We have considered the transportation and prevent you from the headache, as the house are in easily accessible locations.`
        },
        {
          icon: <IoLogoEuro />,
          title: "market",
          info: `You need a place close to the shop, the mall, a recreational centre ? Well look no further 
